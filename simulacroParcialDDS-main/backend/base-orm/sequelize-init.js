  ...
  "empresas",
  {
    ...
    RazonSocial: {
      ...
      validate: {
        notEmpty: {
          args: true,
          msg: "Razón social es requerido",
        },
        len: {
          args: [5, 60],
          msg: "Razón social debe ser tipo carateres, entre 5 y 60 de longitud",
        },
      },
      unique: {
        args: true,
        msg: "esta Razón social ya existe en la tabla!",
      },
    },
    Empleados: {
      type: DataTypes.INTEGER,
